  ...
  private buildDocument(): void {
    ...
    const dataRows = [
      ...
      [
        ...
        new TableCellComponent(`$ ${this.deliveryData.total.toFixed(2)}`).setMargin([0, 10, 0, 10]).setAlignment('right')
      ]
    ];
    ...
    this.addComponent(new SectionComponent({
      ...
      ).setTextColor(Colors.WHITE).setSectionColor(Colors.TOREA_BAY)
    );
    ...
    const productHeaders = [
      new TableCellComponent('Descripción').setFillColor('#E6F7F7').setAlignment('left').setMargin([0, 8, 0, 0]),
      new TableCellComponent('Precio Unitario').setFillColor('#E6F7F7').setAlignment('left').setMargin([0, 8, 0, 0]),
      new TableCellComponent('Cant.').setFillColor('#E6F7F7').setAlignment('center').setMargin([0, 8, 0, 0]),
      new TableCellComponent('Subtotal').setFillColor('#E6F7F7').setAlignment('center').setMargin([0, 8, 0, 0]),
      new TableCellComponent('IVA').setFillColor('#E6F7F7').setAlignment('center').setMargin([0, 8, 0, 0]),
      new TableCellComponent('Total').setFillColor('#E6F7F7').setAlignment('center').setMargin([0, 8, 0, 0])
    ];
